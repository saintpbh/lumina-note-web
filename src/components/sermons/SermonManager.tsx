...
export const SermonManager: React.FC<SermonManagerProps> = ({
    isOpen,
    onClose,
    onSelectSermon,
    ...
    useEffect(() => {
        if (searchQuery.trim() === '') {
            ...
            setFilteredSermons(initialSermons.filter(s =>
                s.title.toLowerCase().includes(query) ||
                (s.passage && s.passage.toLowerCase().includes(query)) ||
            ...
            <div className="bg-white dark:bg-[#1C1C1E] w-full max-w-5xl h-[80vh] rounded-3xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-800 flex flex-col">
                ...
                <div className="p-6 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">Manage your sermons, versions, and backups</p>
                    </div>
                                        ...
                                        filteredSermons.map(sermon => (
                                            ...
                                            >
                                                <div className="flex-1 space-y-1">
                                                    <h3 className="font-bold text-slate-900 dark:text-slate-100 luxury-serif group-hover:text-blue-500 transition-colors">
                                ...
                                <div className="p-8 space-y-8">
                                    <div className="p-6 rounded-3xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-gray-800 flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-1">Coming soon for web version.</p>
                                        </div>
                                        <button className="px-4 py-2 rounded-xl bg-gray-200 dark:bg-white/10 text-gray-400 text-xs font-bold uppercase tracking-wider cursor-not-allowed">
                                            Connect
                                        </button>
                                    </div>
                                </div>
